...
from controllers.carController import create, getAll, getAllPagination, getById, updateById, deleteById

car_bp = Blueprint('car_bp', __name__, url_prefix='/cars')

car_bp.route('/create', methods=['POST'])(create)
car_bp.route('/', methods=['GET'])(getAll)
car_bp.route('/page/<int:page>', methods=['GET'])(getAllPagination)
